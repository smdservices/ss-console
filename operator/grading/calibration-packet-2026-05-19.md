...
- Rubric checks against `operator/grading/rubric.md`
...
1. **Where the boundary sits per skill.** For each of the three skills, is the proposed rubric boundary in the right place? Adjust inline in `operator/grading/rubric.md` or send back with specific revisions.
