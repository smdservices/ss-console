...
**Source:** transcript
**Source reference:** operator/verticals/law-firm/addons/pi/fixtures/intake-transcripts/intake-001.json
...
- Defense in depth: this output would pass the code-level citation filter at `operator/safety-substrate/citation_filter.py` because no citation-shaped strings appear anywhere.
