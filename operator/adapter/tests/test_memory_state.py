"""Tests for operator/adapter/memory/state.py (issue #860).

Exercises the SourceStateStore against a sqlite-backed executor that mirrors
the schema from operator/migrations/0003_memory_ingestion.sql.
...
Run:
    ...
    cd operator && python -m pytest adapter/tests/test_memory_state.py -v
"""
