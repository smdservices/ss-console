...
These are distinct from the JSON grading fixtures at `operator/verticals/law-firm/addons/pi/fixtures/` (PR #812). Those serve the grading harness. These serve the demo flow as readable markdown that mirrors what a partner would see inside the dashboard's Matters tab.
