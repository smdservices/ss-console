...
Skills consume fixtures via the grading harness at `operator/grading/harness.py` (Phase E). The harness reads `metadata.category` to route the fixture to the right skill input shape.
