...
- **Not citation-producing.** Per `references/citation-policy.md` and the substrate filter at `operator/safety-substrate/citation_filter.py`, no subagent and no parent step produces, repeats, or reformulates a legal citation.
