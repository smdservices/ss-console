...
The skill must never produce, repeat, reformulate, or augment any legal citation. This is the law-firm vertical's instance of platform invariant #6 (citation-refusal). The architectural enforcement lives in the citation-refusal substrate at `operator/safety-substrate/citation_filter.py`; the skill's prompt-level discipline below is defense in depth.
