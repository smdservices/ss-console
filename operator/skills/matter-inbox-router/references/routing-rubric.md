...
| **general / operational** | **respond directly** (employee default)        | a colleague or known correspondent with a question, heads-up, or coordination ask that owes no matter action: "can you pull X," "got it, thanks," "are you around Thursday." Reply in-thread; the reply channel sends it to a roster member, drafts it otherwise. |
