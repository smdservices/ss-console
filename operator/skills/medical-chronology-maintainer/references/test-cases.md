...
- **No damages arithmetic.** Each per-row billed amount is extracted as stated, but a
  fixture fails if the skill sums, subtotals, or totals the bills / specials, or puts
  a value on the case (fixture 04). A specials total is a damages figure, the
  attorney's.
