...
`src/lib/operator/capabilities/practice-management.ts` and
`src/lib/operator/capabilities/document-storage.ts`. The contracts
...
class CapabilitySet:
    ...
    `src/lib/operator/capabilities/types.ts`. The conformance
...
# src/lib/operator/capabilities/practice-management.ts.
...
class FilevinePracticeManagement:
    ...
    `src/lib/operator/capabilities/practice-management.ts`. Methods
    ...
    async def create_note(
        ...
        *,
        ...
        account, not "Operator" or the persona. The body is the
