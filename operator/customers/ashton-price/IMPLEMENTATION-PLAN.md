...
| 12  | Alert-routing fallback contact (who receives a case alert when a matter has no usable Smokeball assignment; #2004)              | Christa          | Authored `case_alert_routing.fallback_recipients`; until then resolution failure holds fail-closed and flags the matter |
