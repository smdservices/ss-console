...
- The **canonical reconciliation target** is `07` (Scott's written responses + the routine-settings
  matrix, sent 2026-07-09). It answers `06` and makes the contractual commitments — the per-routine
  three-tier dial, the permanent caps (deadlines / money / opposing counsel / court), the
  deadline-engine posture, CoCounsel dropped, chronology gap-flagging, training-by-default, and the
  refusal spec. **Both operators are built to `07`'s grid.** The three answers owed by Christa
  landed in `09` (2026-07-23): verification = **3 attempts**, treatment gap = **45 days** (may
  tighten to 30), **grid unchanged**. `09` also sets the alert-routing requirement (case-level
  alerts route per matter via Smokeball assignment, never a single inbox) and asks nine
  pre-signature diligence questions; the Smokeball authorization call is gated on Chris
  reviewing our answers.
- **`10` (2026-07-27)** answers `09` in full: the two settings confirmed, grid unchanged,
  per-matter alert routing committed, and all nine diligence answers (BAA, pricing at the
  ADR 0063 terms with the stand-up waived, entity + insurance, security posture, termination
  data terms, kill switch, access control, AgentMail removed in favor of an M365-tenant
  mailbox, stop-then-reconcile failure mode). Its commitments header is binding. Next move
  is Chris's review, then the Smokeball authorization.

## Timeline (verified against the mailbox; `07` added 2026-07-13)
...
| 07  | 2026-07-09 | **Scott → Christa** | **written responses + routine-settings matrix**              | **CANONICAL outbound** (the reconciliation target — commitments + per-routine grid; 3 answers owed by Christa)                                                                                   | [07\_...](07_2026-07-09_scott-to-christa_responses-and-routine-matrix.md)          |
| 08  | 2026-07-16 | Scott → Christa     | Portal invite + full Operator configuration summary          | substantive outbound (portal = config source of truth; re-asks the 3 owed answers)                                                                                                               | [08\_...](08_2026-07-16_scott-to-christa_portal-and-config-summary.md)             |
| —   | 2026-07-22 | Scott → Christa     | "Have you had a chance to review this?"                      | logistics (nudge)                                                                                                                                                                                | (quoted in msg `19f9106a765c30ff`)                                                 |
| 09  | 2026-07-23 | **Christa → Scott** | **settings + grid acceptance + 9 diligence questions**       | **CANONICAL inbound** (verification=3, gap=45, grid unchanged; per-matter alert routing; 9 pre-signature Qs)                                                                                     | [09\_...](09_2026-07-23_christa-to-scott_settings-grid-and-diligence-questions.md) |
| 10  | 2026-07-27 | **Scott → Christa** | **answers to the nine diligence questions**                  | **CANONICAL outbound** (settings confirmed, grid unchanged, alert routing yes, all 9 answered; msg `19fa4aee294dff3f`, sent as a fresh thread; Chris's review gates the Smokeball authorization) | [10\_...](10_2026-07-27_scott-to-christa_diligence-answers.md)                     |
| —   | 2026-07-27 | Christa → Scott     | "Thank you... I'll review everything with Chris"             | logistics (acknowledgment of 10; no questions, no commitments; ball with the firm)                                                                                                               | (msg `19fa4c3a7b98a107`)                                                           |
