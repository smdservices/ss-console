"""Tests for operator/bin/lib/demo_fixtures.py (issue #890).
...
# operator/ on sys.path so `from bin.lib.demo_fixtures import ...` resolves.
...
def _repo_aie_root() -> Path:
    """Resolve operator/ from the checked-in working tree."""
