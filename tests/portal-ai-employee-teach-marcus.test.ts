 ...
 * (src/lib/portal/ai-employee/teach-marcus.ts) added in #810.
 *
 * The inline rule-add affordance is the partner's natural-moment path
 * for teaching the AI Employee a new memory rule — added during draft
...
} from '../src/lib/portal/ai-employee/teach-marcus'
...
describe('persona-name no-fabrication contract', () => {
  it('never references a hardcoded "Marcus" anywhere in the resolver module', () => {
    ...
    const resolverPath = resolve('src/lib/portal/ai-employee/teach-marcus.ts')
