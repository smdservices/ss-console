...
Fixture JSON lives at `ai-employee/fixtures/marketing-agency/retainer-hours/fixtures.json` (will be generated by the fixture generator in Phase D).
...
1. Run the agent against the synthetic inbox in `ai-employee/fixtures/marketing-agency/retainer-hours/`.
