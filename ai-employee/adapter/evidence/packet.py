...
def _readme_text(
    *,
    ...
    body = (
        ...
        "required.\n\n"
        "## Verification\n\n"
        "Each file in this packet has a SHA-256 hash in `manifest.json`. "
        "To verify a file, hash it and compare to the manifest entry. To "
        "verify the manifest, hash it and compare to the SHA-256 quoted "
        "above and in the summary PDF.\n\n"
        "## Questions\n\n"
