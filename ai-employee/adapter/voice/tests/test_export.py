"""Tests for ai-employee/adapter/voice/export.py (issue #862).
...
Run:
    ...
    cd ai-employee && python -m pytest adapter/voice/tests/test_export.py -v
"""
...
from adapter.voice.export import (  # noqa: E402
...
# extractor that produces this is in adapter/voice/diff.py.
