...
The fixtures live at `ai-employee/verticals/law-firm/addons/pi/skills/demand-letter-draft/fixtures/` (with this skill); the downstream test suites import them. Moving the fixtures elsewhere is a coordinated change across all three suites.
