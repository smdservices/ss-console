...
This is the **first real-data execution** of any SMD AI Employee skill against a paying-customer-shape stack: Hermes on Fly + Composio MCP + Gmail OAuth. Phase A's end-to-end Gmail round-trip is closed by this run.
...
## Grading per `ai-employee/grading/rubric.md`
...
This run is the first entry in the grading matrix at `ai-employee/grading/matrix.md`. Subsequent runs against this skill produce more data points; verdict consolidates once we have 5+ runs.
