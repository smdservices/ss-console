...
- The multi-persona schema lock ([ADR 0011](../../../adr/0011-multi-persona-per-customer.md)) is unchanged. Multi-persona positioning at v1 is governed by [ADR 0012](../../../adr/0012-ai-employee-positioning-doctrine.md) §8.
