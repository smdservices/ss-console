...
**Status:** Approved. The 6-step memory demo is the beta-1 demo centerpiece. Locked in [ADR 0013](../../adr/0013-operator-positioning-doctrine.md) §6 (ethics architecture as combined moat) and informed by the round-2 and round-3 competitive analysis deliverables.
...
Per [ADR 0013](../../adr/0013-operator-positioning-doctrine.md) §2:
...
Use the locked wedge line ([ADR 0013](../../adr/0013-operator-positioning-doctrine.md) §4):
