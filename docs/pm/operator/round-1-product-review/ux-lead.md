...
3. **Draft detail.** To/Subject up top. Body: 4-sentence draft in her voice. Below body, visible without expanding: "Sources: Hendricks matter, 2 memory rules. Tap for detail." **Trust signal currently weak:** sourcing is one tap away, not inline. _Fix above._
4. **Tap "Approve & send to my drafts."** Modal: "This puts the draft in your Outlook drafts under your account. Send it from Outlook when you're ready." Tap Approve. **Trust signal currently weak:** spec copy says "Send to Karen" which is not what happens. _Fix above._
