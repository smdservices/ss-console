...
| ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Harvey** ($11B val, $200M raise Mar 2026)                                    | BigLaw research + drafting; custom agents; Westlaw/Lexis content integration                                            | $1,200-$2,000+/seat/mo with a 20-seat minimum; research-shaped; no operational reach; BigLaw-only. Mid-market expansion intent signaled, but a Phase 3-4 horizon threat (not v1). **We win on operational reach + flat pricing.**      |
...
| **Eve Legal** (1,000+ plaintiff firms; AI Workforce launched Jan 2026)         | AI Workforce: AI Agents (autonomous task execution), AI Auditor (nightly case-wide value detection), AI Analyst         | Per-seat; task-execution focus; no reviewer-as-sender architecture; no customer-editable memory. **We win on reviewer-as-sender governance architecture + customer-editable memory + flat-monthly SKU.**                               |
| **EvenUp + PLAAS** (loudest PI competitor; PLAAS launched May 13, 2026)        | PLAAS: full pre-litigation lifecycle as managed service (AI + U.S.-based human case managers); demand + settlement work | Managed service with embedded labor cost; no named AI teammate; no customer-editable memory; pre-litigation only. **We win on persistent agent identity + editable memory + reviewer-as-sender + lifecycle continuity past PLAAS.**    |
| **Law Practice AI** (300+ PI firms; launched April 2026)                       | "Five-solution AI operating system" framing; end-to-end PI workflow tools                                               | Vertical SaaS with discrete workflow tools; no verified persistent-identity agent, reviewer-as-sender, or customer-editable memory architecture (unverified; threat level medium pending product detail). **We win on the same axes.** |
| **Precedent, Tavrn, Supio** (PI demand-side cluster)                           | Variations on demand-letter assembly. Supio markets "learns your voice" for demands                                     | Demand-only. **We win on lifecycle scope + editable memory.**                                                                                                                                                                          |
...
| **Lawmatics AI Suite** (QualifyAI + EngageAI + MerlinAI, March 2026)           | Intake + early-lifecycle agentic operations across email, phone, text, chat; in-platform copilot for automations        | Front-of-funnel and early-matter operations focus; no matter-lifecycle continuity past conversion. **We win on full-lifecycle continuity.**                                                                                            |
| **Microsoft 365 Copilot** (hired Robin AI's eng team + IP; Robin AI shuttered) | Word-native AI redlining, contract review summarization, generic horizontal AI                                          | Doesn't know matter; doesn't know firm rules; doesn't ghostwrite partner voice. **Platform-level threat. We win on legal-domain context.**                                                                                             |

**Watch item: Smokeball + CoCounsel (March 2026).** Smokeball and Thomson Reuters announced a partnership integrating CoCounsel directly into Smokeball: documents flow from Smokeball into CoCounsel in bulk, with Archie's agentic reasoning as the coordination layer. Smokeball does not dominate PI practice management (Filevine, SmartAdvocate, CASEpeer lead PI), so this is not a named competitor in the beta-1 room. But the partnership signals PM vendor strategic direction. If Filevine or Clio announces a comparable research/drafting partnership, the Tier-1 PM adapter strategy carries new competitive risk.

### 10.1.1 EvenUp PLAAS response (Captain 30-second answer)
...
Microsoft hired Robin AI's engineering team and IP in early 2026; Robin AI shuttered as a going concern. M365 Copilot is increasingly capable inside Office. M365 is the email/document substrate of ~70-80% of mid-to-large U.S. law firms.
