# Operator Code Review — VERIFIED Findings (supersedes the 2026-05-31 draft)
...
| `operator-access` 5 symbols | **MIXED** | over-exported (used internally) — drop `export`, don't delete. |
