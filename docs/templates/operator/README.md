...
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`service-contract.md`](./service-contract.md)                             | Master agreement for the Operator service. Covers scope, monthly fee, term, termination, SLA, liability, dispute resolution.         | Every paying Operator customer signs this.                                                                                                                                    |
