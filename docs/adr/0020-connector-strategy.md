...
| DocumentStorage                  | OneDrive / SharePoint                    | `build:microsoft_graph` (no first-party MCP exists yet)                                       | Microsoft has shipped M365 Mail/Calendar/Teams/User/Copilot Chat as first-party MCPs but NOT OneDrive/SharePoint as of this revision. Keep build adapter; revisit when MS ships one.                   |
