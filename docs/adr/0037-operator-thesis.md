...
- **The accusatory spine, the anti-tool wedge, and the "off the shelf" framing.** Retired 2026-06-27. "Name the coordinator-shaped hole / 'the role you keep meaning to fill'" opened on a role the owner had failed to fill, which is an accusation; the "worker vs. tool" wedge trashed tools; and "people / software come off the shelf" disparaged the very people and systems an Operator works alongside (a non-starter for a staffing alternative). The spine now centers on **the gap**: capable people and capable systems both leave a space between them where work falls through, and the Operator is a new substrate that fills it (instant expertise on demand, always there). Transience is one quiet factor, not the theme. Phrasing and positioning only; the six tenets stand.
...
- The marketing spine falls out of Tenets 1 and 2: capable people and capable systems both leave a structural gap between them (the connective work no role or app fully owns), and the Operator is a new substrate that fills the space in between. Name **the gap and the thing that fills it**, not "our software drafts your emails." (Earlier cuts that opened on an accusation, or that disparaged people and tools as "off the shelf," are retired; see the rip.)
