...
} from '../../../../../lib/portal/operator/notification-prefs'
import {
...
/**
 * POST /api/portal/products/operator/notification-prefs
 *
 ...
 *   - Caller has any role on (entity, 'operator')
 *
...
const PREFS_PAGE_URL = '/portal/products/operator/settings/notifications'
