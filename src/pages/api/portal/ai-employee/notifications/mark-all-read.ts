...
import { markAllNotificationsRead } from '../../../../../lib/portal/ai-employee/notifications'
import { env } from 'cloudflare:workers'

/**
 * POST /api/portal/ai-employee/notifications/mark-all-read
 *
 * Mark every unread notification on the caller's active AI Employee
