/**
 * Operator Compliance dashboard — read resolver.
 *
 * Backs the dedicated Compliance view at
 * `/portal/products/operator/compliance` (issue #895).
 *
...
import { VERTICAL_AUDIT_LOG_DAYS_DEFAULTS } from '../../operator/customer-yaml'
import type { Vertical } from '../../operator/customer-yaml'
...
export interface ComplianceView {
   ...
   * users. The set is derived upstream by resolveOperatorAccess. */
  callerRoles: string[]
}
