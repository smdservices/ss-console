/**
 * Operator in-app notifications — typed contract + read resolver.
 *
 * Per #876, customers need to be alerted when something they care about
 * happens inside the Operator surface: a draft is ready for review,
 ...
 *
 * Mirrors the shape of `src/lib/portal/operator/drafts.ts` and
 ...
 *   calibration_prompt — The Operator is asking the principal to
