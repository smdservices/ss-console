/**
 * AI Employee settings — typed contracts + read resolver.
 *
 * This module backs the four working sections on
 * `/portal/products/ai-employee/settings`:
 *
 ...
 * `src/pages/api/portal/ai-employee/settings/` accept POSTs, validate,
 ...
 * `src/lib/portal/ai-employee/drafts.ts`, both resolvers return
 ...
 * `docs/specs/ai-employee/customer-yaml-schema.md` §personas[].skills[].
 *
 *   autonomous       — the AI Employee may execute and send without
 *                      a human reviewer in the loop
 *   draft_for_review — default; the AI Employee proposes; a reviewer
 *                      must approve and send
 *   refused          — the skill is configured but the AI Employee
 ...
 * `docs/specs/ai-employee/voice-gate-fallback.md` spec, the portal
