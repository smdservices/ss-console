...
function ScorecardFooter({ pageLabel }: { pageLabel: string }) {
  return (
    <View
      style={{
        position: 'absolute',
    ...
    >
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
        ...
        <Text style={mutedText}>{pageLabel}</Text>
      </View>
    </View>
  )
}
...
interface Page1Props {
  ...
  overallDisplayLabel: string
  overallColor: string
  sortedDimensions: ScorecardDimensionResult[]
  opportunities: ScorecardOpportunity[]
  completedAt: string
}
...
function ScorecardOverallScore({
  overallScore,
  overallDisplayLabel,
  overallColor,
}: {
  ...
  return (
    <View style={{ alignItems: 'center', marginBottom: 32 }}>
      ...
      >
        <Text
          style={{ fontFamily: fonts.body, fontWeight: 600, fontSize: 11, color: overallColor }}
        >
          {overallDisplayLabel}
        </Text>
      </View>
...
function ScorecardDimensionBars({
  sortedDimensions,
}: {
  sortedDimensions: ScorecardDimensionResult[]
}) {
...
function ScorecardOpportunitiesList({ opportunities }: { opportunities: ScorecardOpportunity[] }) {
  ...
  return (
    <Page size="Letter" margin={pageMargins}>
      ...
      <ScorecardOverallScore
        ...
        overallDisplayLabel={overallDisplayLabel}
        overallColor={overallColor}
      />
      <ScorecardDimensionBars sortedDimensions={sortedDimensions} />
      <ScorecardOpportunitiesList opportunities={opportunities} />
      <ScorecardFooter pageLabel="Operations Health Report | Page 1 of 2" />
    </Page>
  )
}

function ScorecardDimensionDetail({
  sortedDimensions,
}: {
  sortedDimensions: ScorecardDimensionResult[]
}) {
...
function ScorecardCtaSection() {
  return (
    <>
      ...
      >
        <Text
          style={{ fontFamily: fonts.body, fontWeight: 600, fontSize: 11, color: colors.white }}
        >
      ...
      <View style={{ marginTop: 32 }}>
        ...
        <Text style={bodyText}>
          ...
          together. Our team works alongside you to document processes, choose the right tools, and
          get everything running so your operations keep up with your ambition.
        </Text>
      </View>
    </>
  )
...
function ScorecardPage2({ sortedDimensions }: { sortedDimensions: ScorecardDimensionResult[] }) {
  return (
    <Page size="Letter" margin={pageMargins}>
      <ScorecardDimensionDetail sortedDimensions={sortedDimensions} />
      <ScorecardCtaSection />
      <ScorecardFooter pageLabel="Operations Health Report | Page 2 of 2" />
    </Page>
  )
}
  ...
  return (
    <Document>
      <ScorecardPage1
        ...
        completedAt={completedAt}
      />
      <ScorecardPage2 sortedDimensions={sortedDimensions} />
    </Document>
  )
}
